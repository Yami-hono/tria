...
echo "<script>alert('$name is added succcesfully'); window.location.href='teach_home.php';</script>";
}
else
{
	echo "error creating table". $con->error;
	echo "<script>alert('Course  $name already exist '); window.location.href='teach_home.php';</script>";
}
